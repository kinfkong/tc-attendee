...
/**
 * The user quiz answer REST controller. Is effectively thread safe.
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
@RestController
@RequestMapping("/userQuizAnswers")
@NoArgsConstructor
public class UserQuizAnswerController {
    ...
    public UserQuizAnswer get(@PathVariable String id) throws AttendeeException {
    ...
    @Transactional
    public UserQuizAnswer create(@RequestBody UserQuizAnswer entity) throws AttendeeException  {
    ...
    @Transactional
    public UserQuizAnswer update(@PathVariable String id, @RequestBody UserQuizAnswer entity)
    ...
    public SearchResult<UserQuizAnswer> search(@ModelAttribute UserQuizAnswerSearchCriteria criteria,
