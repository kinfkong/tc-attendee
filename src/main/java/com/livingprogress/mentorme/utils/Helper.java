...
public class Helper {
    ...
    private static final List<Class> NOLOGS = Arrays.asList(HttpServletRequest.class,
            HttpServletResponse.class, ModelAndView.class, mentorme.entities.NewPassword.class, MultipartFile[].class, ResponseEntity.class);
    ...
    public static void checkNull(Object object, String name) throws IllegalArgumentException {
        if (object == null) {
            throw new IllegalArgumentException(mentorme.utils.CustomMessageSource.getMessage("checkNull.error", name));
        }
    }
     ...
     */
    public static <T extends mentorme.entities.IdentifiableEntity> void checkEntity(T object, String name)
    ...
    public static void checkNullOrEmpty(String str, String name) throws IllegalArgumentException {
        if (isNullOrEmpty(str)) {
            throw new IllegalArgumentException(
                    mentorme.utils.CustomMessageSource.getMessage("checkNullOrEmpty.error", name));
        }
    }
    ...
    public static void checkPositive(long value, String name) {
        if (value <= 0) {
            throw new IllegalArgumentException(mentorme.utils.CustomMessageSource.getMessage("checkPositive.error", name));
        }
    }
    ...
    public static void checkEmail(String value, String name) {
        ...
        if (!isEmail(value)) {
            throw new IllegalArgumentException(mentorme.utils.CustomMessageSource.getMessage("checkEmail.error", name));
        }
    }
    ...
    public static void checkConfigNotNull(Object object, String name) {
        if (object == null) {
            throw new ConfigurationException(mentorme.utils.CustomMessageSource.getMessage("checkNull.error", name));
        }
    }
    ...
    public static void checkDirectory(String path, String name) {
        if (Helper.isNullOrEmpty(path)) {
            throw new ConfigurationException(mentorme.utils.CustomMessageSource.getMessage("checkNullOrEmpty.error", name));
        }
        File file = new File(path);
        if (!file.exists() || !file.isDirectory()) {
            throw new ConfigurationException(mentorme.utils.CustomMessageSource.getMessage("checkDirectory.error", name));
        }
    }
    ...
    public static void checkConfigPositive(long value, String name) {
        if (value <= 0) {
            throw new ConfigurationException(mentorme.utils.CustomMessageSource.getMessage("checkPositive.error", name));
        }
    }
    ...
    public static void logEntrance(Logger logger, String signature, String[] paramNames, Object[] params) {
        if (logger.isDebugEnabled()) {
            String msg = mentorme.utils.CustomMessageSource.getMessage("log.entering", signature) + toString(paramNames, params);
            logger.debug(msg);
        }
    }
    ...
    public static void logExit(Logger logger, String signature, Object value) {
        if (logger.isDebugEnabled()) {
            String msg = mentorme.utils.CustomMessageSource.getMessage("log.exiting", signature);
            if (value != null) {
                msg += mentorme.utils.CustomMessageSource.getMessage("log.output") + toString(value);
            }
            logger.debug(msg);
        }
    }
    ...
    public static <T extends Throwable> void logException(Logger logger, String signature, T ex) {
        ...
        sw.append(mentorme.utils.CustomMessageSource.getMessage("log.error", signature)).append(": ").append(ex.getMessage());
    ...
    private static String toString(String[] paramNames, Object[] params) {
        StringBuilder sb = new StringBuilder(mentorme.utils.CustomMessageSource.getMessage("log.input"));
        sb.append("{");
        if (params != null) {
    ...
    public static String toString(Object obj) {
        ...
        try {
            ...
            result = mentorme.utils.CustomMessageSource.getMessage("json.error", e.getMessage());
        }
        return result;
    }
     ...
     */
    public static <T extends mentorme.entities.IdentifiableEntity> Predicate
    buildInPredicate(List<T> val, Predicate pd, Path<?> path, CriteriaBuilder cb) {
        if (val != null && !val.isEmpty()) {
            List<Long> ids = val.stream().map(mentorme.entities.IdentifiableEntity::getId).collect(Collectors.toList());
    ...
    buildPredicate(mentorme.entities.InstitutionUserSearchCriteria criteria, Predicate pd, Root<?> root, CriteriaBuilder cb) {
     ...
     */
    public static <T extends mentorme.entities.IdentifiableEntity> Long getId(T entity) {
        Long id = null;
        if (entity != null) {
            id = entity.getId();
        }
     ...
     * @return true if value has been updated.
     */
    public static <T extends mentorme.entities.IdentifiableEntity> boolean isUpdated(List<T> oldValues, List<T> newValues) {
        List<Long> oldIds = oldValues == null ? Collections.emptyList()
                : oldValues.stream().map(mentorme.entities.IdentifiableEntity::getId).collect(Collectors.toList());
     ...
     * @return true if value has been updated.
     */
    public static <T extends mentorme.entities.WeightedPersonalInterest> boolean
     ...
     * @return true if value has been updated.
     */
    public static <T extends mentorme.entities.WeightedProfessionalInterest> boolean
    ...
    public static <T extends mentorme.entities.MenteeSkill> boolean
     ...
     * @return true if value has been updated.
     */
    public static <T extends mentorme.entities.InstitutionUser> boolean isUpdated(T oldEntity, T newEntity) {
        if (isBothNull(oldEntity, newEntity)) {
            return false;
        }
     ...
     * @return true if value has been updated.
     */
    public static <T extends mentorme.entities.ProfessionalExperienceData> boolean
     ...
     * @return true if value has been updated.
     */
    public static <T extends mentorme.entities.Mentor> boolean isUpdated(T oldEntity, T newEntity) {
        if (isBothNull(oldEntity, newEntity)) {
            return false;
        }
        boolean updated = isUpdated((mentorme.entities.InstitutionUser) oldEntity, (mentorme.entities.InstitutionUser) newEntity);
     ...
     * @return true if value has been updated.
     */
    public static boolean isUpdatedParentConsent(mentorme.entities.ParentConsent oldEntity, mentorme.entities.ParentConsent newEntity) {
        if (isBothNull(oldEntity, newEntity)) {
            return false;
        }
    ...
    isUpdatedInstitutionAffiliationCode(mentorme.entities.InstitutionAffiliationCode oldEntity, mentorme.entities.InstitutionAffiliationCode newEntity) {
        if (isBothNull(oldEntity, newEntity)) {
            return false;
        }
        return isUpdated(oldEntity, newEntity)
     ...
     * @return true if value has been updated.
     */
    public static <T extends mentorme.entities.Mentee> boolean isUpdated(T oldEntity, T newEntity) {
        if (isBothNull(oldEntity, newEntity)) {
            return false;
        }
        boolean updated = isUpdated((mentorme.entities.InstitutionUser) oldEntity, (mentorme.entities.InstitutionUser) newEntity);
     ...
     */
    public static mentorme.entities.PersonalInterest getParentCategoryFromWeightedPersonalInterest(mentorme.entities.WeightedPersonalInterest entity) {
     ...
     * @return parent category
     */
    public static mentorme.entities.ProfessionalInterest
    getParentCategoryFromWeightedProfessionalInterest(mentorme.entities.WeightedProfessionalInterest entity) {
     ...
     */
    public static <T extends mentorme.entities.IdentifiableEntity> int getScore(int directMatchingPoints,
                                                                                int parentCategoryMatchingPoints, List<T> interests1, List<T> interests2,
                                                                                Function<? super T, Integer> weightExtractor,
                                                                                Function<? super T, mentorme.entities.IdentifiableEntity> interestExtractor,
                                                                                Function<? super T, mentorme.entities.IdentifiableEntity> parentCategoryExtractor) {
        int score = 0;
        while (!interests1.isEmpty()) {
            ...
            for (T interest : interests2) {
                int matchingScore = 0;
                mentorme.entities.IdentifiableEntity interest1 = interestExtractor.apply(maxWeightInterest);
                mentorme.entities.IdentifiableEntity interest2 = interestExtractor.apply(interest);
                mentorme.entities.IdentifiableEntity parentCategory1 = parentCategoryExtractor.apply(maxWeightInterest);
                mentorme.entities.IdentifiableEntity parentCategory2 = parentCategoryExtractor.apply(interest);
    ...
    public static boolean isMentor() {
        ...
        for (mentorme.entities.UserRole r : user.getRoles()) {
     ...
     */
    public static <T extends mentorme.entities.AuditableUserEntity> void audit(T entity)  {
        User user = getAuthUser();
        if (user != null) {
            Date now = new Date();
     ...
     */
    public static  void audit(mentorme.services.springdata.ActivityRepository activityRepository,
                              mentorme.entities.ActivityType activityType, long objectId,
                              String description, Long institutionalProgramId, Long menteeId, Long mentorId, boolean global)  {
        User user = getAuthUser();
        if (user != null) {
            mentorme.entities.Activity activity = new mentorme.entities.Activity();
            audit(activity);
     ...
     */
    public static  void audit(mentorme.services.springdata.ActivityRepository activityRepository,
                              mentorme.services.springdata.MenteeMentorProgramRepository menteeMentorProgramRepository,
                              mentorme.entities.ActivityType activityType, long objectId,
        ...
        if (user != null) {
            ...
            if (menteeMentorProgramId != null) {
                mentorme.entities.MenteeMentorProgram program = menteeMentorProgramRepository.findOne(menteeMentorProgramId);
        ...
        if (documents != null && documents.length > 0) {
            for (MultipartFile document: documents) {
                try {
                    ...
                    throw new MentorMeException(mentorme.utils.CustomMessageSource.getMessage("uploadDocument.error"), e);
                }
            }
        }
        return docs;
     ...
     */
    public static <T extends mentorme.entities.IdentifiableEntity> void checkUpdate(long id, T entity) {
        checkPositive(id, "id");
        checkNull(entity, "entity");
        checkPositive(entity.getId(), "entity.id");
        if (entity.getId() != id) {
            throw new IllegalArgumentException(mentorme.utils.CustomMessageSource.getMessage("update.notSameId.error"));
        }
    }
     ...
     */
    public static <T extends mentorme.entities.InstitutionUserSearchCriteria, S extends mentorme.entities.InstitutionUser, R extends mentorme.entities.InstitutionUser>
     List<R> searchMatchEntities(S entity, T criteria, mentorme.entities.MatchSearchCriteria matchSearchCriteria,
        ...
        mentorme.entities.Paging paging = null;
        ...
        if (matchSearchCriteria != null) {
            ...
            if (matchSearchCriteria.getMaxCount() != null) {
                ...
                paging = new mentorme.entities.Paging();
