...
public class LookupController {
    ...
    public List<mentorme.entities.UserRole> getUserRoles() throws MentorMeException {
    ...
    public List<mentorme.entities.Country> getCountries() throws MentorMeException {
    ...
    public List<mentorme.entities.ProfessionalConsultantArea> getProfessionalConsultantAreas() throws MentorMeException {
    ...
    public List<mentorme.entities.GoalCategory> getGoalCategories() throws MentorMeException {
    ...
    public List<mentorme.entities.ProgramCategory> getProgramCategories() throws MentorMeException {
