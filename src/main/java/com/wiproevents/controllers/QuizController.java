...
public class QuizController {
    ...
    public Quiz get(@PathVariable String id) throws AttendeeException {
    ...
    public SearchResult<Quiz> search(@ModelAttribute QuizSearchCriteria criteria,
                                          @ModelAttribute Paging paging) throws AttendeeException  {
        return quizService.search(criteria, paging);
    }
}
