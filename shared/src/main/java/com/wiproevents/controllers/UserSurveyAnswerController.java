...
/**
 * The user survey answer REST controller. Is effectively thread safe.
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
@RestController
@RequestMapping("/userSurveyAnswers")
@NoArgsConstructor
public class UserSurveyAnswerController {
    ...
    protected void checkConfiguration() {
        Helper.checkConfigNotNull(userSurveyAnswerService, "userSurveyAnswerService");
    }
    ...
    public UserSurveyAnswer get(@PathVariable String id) throws AttendeeException {
        return userSurveyAnswerService.get(id);
    }
    ...
    @Transactional
    public UserSurveyAnswer create(@RequestBody UserSurveyAnswer entity) throws AttendeeException  {
        return userSurveyAnswerService.create(entity);
    }
    ...
    @Transactional
    public UserSurveyAnswer update(@PathVariable String id, @RequestBody UserSurveyAnswer entity)
            throws AttendeeException  {
        return userSurveyAnswerService.update(id, entity);
    }
    ...
    public void delete(@PathVariable String id) throws AttendeeException  {
        userSurveyAnswerService.delete(id);
    }
    ...
    public SearchResult<UserSurveyAnswer> search(@ModelAttribute UserSurveyAnswerSearchCriteria criteria,
                                          @ModelAttribute Paging paging) throws AttendeeException  {
        return userSurveyAnswerService.search(criteria, paging);
    }
}
