...
/**
 * The user event feedback REST controller. Is effectively thread safe.
 *
 * @author TCSDEVELOPER
 * @version 1.0
 */
@RestController
@RequestMapping("/userEventFeedbacks")
@NoArgsConstructor
public class UserEventFeedbackController {

    /**
     * The service used to perform operations. Should be non-null after injection.
     */
    @Autowired
    private UserEventFeedbackService userEventFeedbackService;
    ...
    protected void checkConfiguration() {
        Helper.checkConfigNotNull(userEventFeedbackService, "userEventFeedbackService");
    }
    ...
    public UserEventFeedback get(@PathVariable String id) throws AttendeeException {
        return userEventFeedbackService.get(id);
    }
    ...
    @Transactional
    public UserEventFeedback create(@RequestBody UserEventFeedback entity) throws AttendeeException  {
        return userEventFeedbackService.create(entity);
    }
    ...
    @Transactional
    public UserEventFeedback update(@PathVariable String id, @RequestBody UserEventFeedback entity)
            throws AttendeeException  {
        return userEventFeedbackService.update(id, entity);
    }
    ...
    public void delete(@PathVariable String id) throws AttendeeException  {
        userEventFeedbackService.delete(id);
    }
    ...
    public SearchResult<UserEventFeedback> search(@ModelAttribute UserEventFeedbackSearchCriteria criteria,
                                          @ModelAttribute Paging paging) throws AttendeeException  {
        return userEventFeedbackService.search(criteria, paging);
    }
}
