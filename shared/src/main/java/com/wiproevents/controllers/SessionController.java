...
public class SessionController {
    ...
    protected void checkConfiguration() {
        Helper.checkConfigNotNull(sessionService, "sessionService");
    }
    ...
    public Session get(@PathVariable String id) throws AttendeeException {
    ...
    @Transactional
    public Session create(@RequestBody Session entity) throws AttendeeException  {
        return sessionService.create(entity);
    }
    ...
    @Transactional
    public Session update(@PathVariable String id, @RequestBody Session entity) throws AttendeeException  {
        return sessionService.update(id, entity);
    }
    ...
    public SearchResult<Session> search(@ModelAttribute SessionSearchCriteria criteria,
                                        @ModelAttribute Paging paging) throws AttendeeException  {
        return sessionService.search(criteria, paging);
    }
}
